...
function fetch_and_set()
{
    ...
    axios.get("http://localhost:3001/api/v1/tasks/"+id)
    .then((response)=>
    {
...
{
    url = "http://127.0.0.1:5500/backend/public/index.html";
...
{
    let id = localStorage.getItem('task_id')
    axios.patch("http://localhost:3001/api/v1/tasks/"+id,{"_id":id,"name":enter_task_name.value,"completed":completed.checked})
    .then((response)=>
    {
